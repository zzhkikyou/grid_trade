...
public:
    ...
    ParseResult parse(Request &req, const char *begin, const char *end, uint32_t &RealLength)
    {
        return consume(req, begin, end, RealLength);
    }
...
private:
    ...
    ParseResult consume(Request &req, const char *begin, const char *end, uint32_t &RealLength)
    {
