...
public:
    ...
    ParseResult parse(Response &resp, const char *begin, const char *end, uint32_t &RealLength)
    {
        return consume(resp, begin, end, RealLength);
    }
...
private:
    ...
    ParseResult consume(Response &resp, const char *begin, const char *end, uint32_t &RealLength)
    {
        resp.Reset();
        state = ResponseStatusStart,
        contentSize = 0,
